...
typedef enum eDrawMode { NEUTRAL, BLACK_WINS, WHITE_WINS, OPPONENT_WINS } DrawMode;
...
typedef enum eGameMode { PRIVATE_GAME, PUBLIC_GAME } GameMode;

typedef struct tagCandidateMove {
	int move;
	int score;
	int flags;
	int parent_flags;
