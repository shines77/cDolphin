...
extern int row_no[64];
extern int row_index[64];
extern int col_no[64];
extern int col_index[64];
...
extern unsigned int depend_lo[64];
extern unsigned int depend_hi[64];
