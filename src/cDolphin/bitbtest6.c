...
static int
TestFlips_bitboard6_a1( const BitBoard my_bits,
	...
	opp_discs2 = (((opp_bits.low & 0x01010101ul) | ((opp_bits.high & 0x00010101ul) << 4)) * 0x01020408ul) >> 25;
	my_discs2 = (((my_bits.low & 0x01010101ul) | ((my_bits.high & 0x01010101ul) << 4)) * 0x01020408ul) >> 24;
	opp_discs3 = (((opp_bits.low & 0x08040201ul) | (opp_bits.high & 0x00402010ul)) * 0x01010101ul) >> 25;
	my_discs3 = (((my_bits.low & 0x08040201ul) | (my_bits.high & 0x80402010ul)) * 0x01010101ul) >> 24;
	...
	flipped_bits = flipped_discs * 0x00204081ul;
	...
	flipped_bits = flipped_discs * 0x01010101ul;
...
static int
TestFlips_bitboard6_h1( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_a8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_h8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b1( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
#if 1
static int
TestFlips_bitboard6_g1( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
...
static int
TestFlips_bitboard6_a2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_h2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_a7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_h7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_g8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_g2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_g7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c1( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f1( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_a3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_h3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_a6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_h6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d1( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e1( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_a4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_h4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_a5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_h5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e8( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_g3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_g6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e2( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_g4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_b5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_g5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e7( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e3( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_c5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_f5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e6( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e4( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_d5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
static int
TestFlips_bitboard6_e5( const BitBoard my_bits,
					  const BitBoard opp_bits ) {
	unsigned long flips_hi;
	unsigned long flips_lo;
	int flip_count;
...
int (*TestFlips_bitboard6[64])(const BitBoard,const BitBoard) = {

	TestFlips_bitboard6_a1,
	TestFlips_bitboard6_b1,
	TestFlips_bitboard6_c1,
	TestFlips_bitboard6_d1,
	TestFlips_bitboard6_e1,
	TestFlips_bitboard6_f1,
	TestFlips_bitboard6_g1,
	TestFlips_bitboard6_h1,

	TestFlips_bitboard6_a2,
	TestFlips_bitboard6_b2,
	TestFlips_bitboard6_c2,
	TestFlips_bitboard6_d2,
	TestFlips_bitboard6_e2,
	TestFlips_bitboard6_f2,
	TestFlips_bitboard6_g2,
	TestFlips_bitboard6_h2,

	TestFlips_bitboard6_a3,
	TestFlips_bitboard6_b3,
	TestFlips_bitboard6_c3,
	TestFlips_bitboard6_d3,
	TestFlips_bitboard6_e3,
	TestFlips_bitboard6_f3,
	TestFlips_bitboard6_g3,
	TestFlips_bitboard6_h3,

	TestFlips_bitboard6_a4,
	TestFlips_bitboard6_b4,
	TestFlips_bitboard6_c4,
	TestFlips_bitboard6_d4,
	TestFlips_bitboard6_e4,
	TestFlips_bitboard6_f4,
	TestFlips_bitboard6_g4,
	TestFlips_bitboard6_h4,

	TestFlips_bitboard6_a5,
	TestFlips_bitboard6_b5,
	TestFlips_bitboard6_c5,
	TestFlips_bitboard6_d5,
	TestFlips_bitboard6_e5,
	TestFlips_bitboard6_f5,
	TestFlips_bitboard6_g5,
	TestFlips_bitboard6_h5,

	TestFlips_bitboard6_a6,
	TestFlips_bitboard6_b6,
	TestFlips_bitboard6_c6,
	TestFlips_bitboard6_d6,
	TestFlips_bitboard6_e6,
	TestFlips_bitboard6_f6,
	TestFlips_bitboard6_g6,
	TestFlips_bitboard6_h6,

	TestFlips_bitboard6_a7,
	TestFlips_bitboard6_b7,
	TestFlips_bitboard6_c7,
	TestFlips_bitboard6_d7,
	TestFlips_bitboard6_e7,
	TestFlips_bitboard6_f7,
	TestFlips_bitboard6_g7,
	TestFlips_bitboard6_h7,

	TestFlips_bitboard6_a8,
	TestFlips_bitboard6_b8,
	TestFlips_bitboard6_c8,
	TestFlips_bitboard6_d8,
	TestFlips_bitboard6_e8,
	TestFlips_bitboard6_f8,
	TestFlips_bitboard6_g8,
	TestFlips_bitboard6_h8
