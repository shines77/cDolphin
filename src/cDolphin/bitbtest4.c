...
ALIGN_PREFIX(16) BitBoard bb_flips4 ALIGN_SUFFIX(16);
...
init_disc_mask_4(void) {
    ...
    now_bit = 1;
    mask_left[0] = 0;
    mask_right[0] = (unsigned char)(~1);  // 0xfe
    for (i = 1; i < 8; i++) {
...
static int
TestFlips_bitboard4_a1(const BitBoard my_bits,
    ...
    //opp_discs2 = ((((opp_bits.low & 0x01010101ul) | ((opp_bits.high & 0x01010101ul) << 4)) * 0x00204081ul) & 0x0fc00000ul) >> 22;
    //my_discs2 = ((((my_bits.low & 0x01010101ul) | ((my_bits.high & 0x01010101ul) << 4)) * 0x00204081ul) & 0x1fe00000ul) >> 21;
    flipped_discs = my_mask[FILE_A1][opp_mask[FILE_A1][opp_discs2] & my_discs2];
    ...
    //opp_discs3 = ((((opp_bits.low & 0x08040201ul) | (opp_bits.high & 0x80402010ul)) * 0x01010101ul) & 0x7e000000ul) >> 25;
    //my_discs3 = ((((my_bits.low & 0x08040201ul) | (my_bits.high & 0x80402010ul)) * 0x01010101ul) & 0xff000000ul) >> 24;
    flipped_discs = my_mask[DIAG1_A1][opp_mask[DIAG1_A1][opp_discs3] & my_discs3];
...
static int
TestFlips_bitboard4_h1(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_a8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_h8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b1(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
#if 1
static int
TestFlips_bitboard4_g1(const BitBoard my_bits,
    const BitBoard opp_bits) {
...
TestFlips_bitboard4_g1(const BitBoard my_bits, const BitBoard opp_bits) {
    __asm {
        push edi
        push esi
        push ebp
...
static int
TestFlips_bitboard4_a2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_h2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_a7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_h7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_g8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_g2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_g7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c1(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f1(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_a3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_h3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_a6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_h6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d1(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e1(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_a4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_h4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_a5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_h5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e8(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_g3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_g6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e2(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_g4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_b5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_g5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e7(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e3(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_c5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_f5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e6(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e4(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_d5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
static int
TestFlips_bitboard4_e5(const BitBoard my_bits,
    const BitBoard opp_bits) {
    unsigned long flips_hi;
    unsigned long flips_lo;
    int flip_count;
...
int(*TestFlips_bitboard4[64])(const BitBoard, const BitBoard) = {

    TestFlips_bitboard4_a1,
    TestFlips_bitboard4_b1,
    TestFlips_bitboard4_c1,
    TestFlips_bitboard4_d1,
    TestFlips_bitboard4_e1,
    TestFlips_bitboard4_f1,
    TestFlips_bitboard4_g1,
    TestFlips_bitboard4_h1,

    TestFlips_bitboard4_a2,
    TestFlips_bitboard4_b2,
    TestFlips_bitboard4_c2,
    TestFlips_bitboard4_d2,
    TestFlips_bitboard4_e2,
    TestFlips_bitboard4_f2,
    TestFlips_bitboard4_g2,
    TestFlips_bitboard4_h2,

    TestFlips_bitboard4_a3,
    TestFlips_bitboard4_b3,
    TestFlips_bitboard4_c3,
    TestFlips_bitboard4_d3,
    TestFlips_bitboard4_e3,
    TestFlips_bitboard4_f3,
    TestFlips_bitboard4_g3,
    TestFlips_bitboard4_h3,

    TestFlips_bitboard4_a4,
    TestFlips_bitboard4_b4,
    TestFlips_bitboard4_c4,
    TestFlips_bitboard4_d4,
    TestFlips_bitboard4_e4,
    TestFlips_bitboard4_f4,
    TestFlips_bitboard4_g4,
    TestFlips_bitboard4_h4,

    TestFlips_bitboard4_a5,
    TestFlips_bitboard4_b5,
    TestFlips_bitboard4_c5,
    TestFlips_bitboard4_d5,
    TestFlips_bitboard4_e5,
    TestFlips_bitboard4_f5,
    TestFlips_bitboard4_g5,
    TestFlips_bitboard4_h5,

    TestFlips_bitboard4_a6,
    TestFlips_bitboard4_b6,
    TestFlips_bitboard4_c6,
    TestFlips_bitboard4_d6,
    TestFlips_bitboard4_e6,
    TestFlips_bitboard4_f6,
    TestFlips_bitboard4_g6,
    TestFlips_bitboard4_h6,

    TestFlips_bitboard4_a7,
    TestFlips_bitboard4_b7,
    TestFlips_bitboard4_c7,
    TestFlips_bitboard4_d7,
    TestFlips_bitboard4_e7,
    TestFlips_bitboard4_f7,
    TestFlips_bitboard4_g7,
    TestFlips_bitboard4_h7,

    TestFlips_bitboard4_a8,
    TestFlips_bitboard4_b8,
    TestFlips_bitboard4_c8,
    TestFlips_bitboard4_d8,
    TestFlips_bitboard4_e8,
    TestFlips_bitboard4_f8,
    TestFlips_bitboard4_g8,
    TestFlips_bitboard4_h8
